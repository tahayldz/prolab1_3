...
void Sil(int x)
{
    ...
    if(sayac==0)
    {
        ...
        fprintf(yaz,"Girilen plakali sehir listede yok.\n");
    ...
    while(adim!=sonK)
    {
        ...
        while(dolas!=sonK)
        {
            if(dolas->tutulanIl > dolas->next->tutulanIl)
            {
                ...
                memcpy(temp,dolas->plaka,40);
                memcpy(dolas->plaka,dolas->next->plaka,40);
                memcpy(dolas->next->plaka,temp,40);
...
int plakaAra(int a)
{
    ...
    if(kontrol==0)
    {
        printf("Sehir listede yok eklemek icin 1'e menu icin 0'a basiniz.\n ");
        scanf("%d",&b);
        if(b==1)
        {
            printf("Sehrin plakasi: ");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(a==7)
        {
            printf("Girilen sinirlar dahil degildir.\n");
